/**
 * PostQuestion: page for users to ask new questions with integrated AI Draft Coach feedback.
 */
...
export default function PostQuestion() {
  ...
  // Enforce validation constraints locally before network handshakes
  const validateForm = () => {
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      const finalId = response.data?.questionHash || response.questionHash || response.data?.id || response.id;
      ...
      {isPostedSuccessfully ? (
        <div className={styles.postQuestion__successCard}>
          <div className={styles.postQuestion__successBadge}>
            <CheckCircle2 size={40} className={styles.postQuestion__successCheckIcon} aria-hidden />
          </div>
        ...
        <div className={styles.postQuestion__container}>
          ...
          <div className={styles.postQuestion__rulesCard}>
            ...
            <div className={styles.postQuestion__rulesSection}>
              <h4 className={styles.postQuestion__sectionHeading}>Checklist before you post</h4>
              <ul className={styles.postQuestion__rulesList}>
                <li className={styles.postQuestion__rulesItem}>
                  <strong>Title as a headline</strong> that states the symptom and tech stack (e.g., “React 19: state resets after navigation”).
                </li>
                <li className={styles.postQuestion__rulesItem}>
                  <strong>Repro steps</strong> numbered, with environment (OS, browser, Node version) when it matters.
                </li>
                <li className={styles.postQuestion__rulesItem}>
                  <strong>Minimal code</strong> in fenced markdown blocks; trim unrelated lines so readers scan faster.
                </li>
                <li className={styles.postQuestion__rulesItem}>
                  <strong>Exact errors</strong> copied verbatim, including stack trace snippets when debugging backend routes.
                </li>
              </ul>
            </div>

            <div className={styles.postQuestion__rulesSection}>
              <h4 className={styles.postQuestion__sectionHeading}>Validation rules (enforced by the form)</h4>
              <ul className={styles.postQuestion__rulesList}>
                <li className={styles.postQuestion__rulesItem}>
                  <strong>Title length:</strong> Must be between 5 and 255 characters.
                </li>
                <li className={styles.postQuestion__rulesItem}>
                  <strong>Body length:</strong> Must contain a minimum of 10 characters detailing your problem.
                </li>
                <li className={styles.postQuestion__rulesItem}>
                  <strong>Single topic:</strong> Split unrelated bugs into separate threads so search and embeddings stay precise.
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className={styles.postQuestion__formWrapper}>
            <form className={styles.postQuestion__form} onSubmit={handleSubmit}>
              ...
              <div className={styles.postQuestion__formGroup}>
                <label htmlFor='title' className={styles.postQuestion__formLabel}>
                  Title
                </label>
              ...
              <div className={styles.postQuestion__formGroup}>
                <label htmlFor='content' className={styles.postQuestion__formLabel}>
                ...
                <div className={styles.postQuestion__editorContainer}>
                  <div className={styles.postQuestion__editorToolbar}>
                    <button type="button" className={styles.postQuestion__toolbarBtn}>B</button>
                    <button type="button" className={styles.postQuestion__toolbarBtn} style={{ fontStyle: 'italic' }}>I</button>
                    <button type="button" className={styles.postQuestion__toolbarBtn}>&lt;/&gt;</button>
                    <button type="button" className={styles.postQuestion__toolbarBtn}>🔗</button>
              ...
              <div className={styles.postQuestion__actionFooter}>
                <div className={styles.postQuestion__aiActionGroup}>
                  ...
                  >
                    ...
                    <span>{isCoaching ? 'Analyzing...' : 'AI suggestions'}</span>
                  </button>
              ...
              <div className={styles.postQuestion__coachPanel}>
                <div className={styles.postQuestion__coachHeader}>
                  <div className={styles.postQuestion__coachTitleRow}>
                    <Sparkles size={18} className={styles.postQuestion__coachIcon} aria-hidden />
                ...
                <div className={styles.postQuestion__coachContent}>
                  ...
                  {coachFeedback.tips && Array.isArray(coachFeedback.tips) && (
                    <div className={styles.postQuestion__tipsListBlock}>
                      <h3 className={styles.postQuestion__tipsTitle}>Suggestions</h3>
                      <ul className={styles.postQuestion__coachTips}>
                        {coachFeedback.tips.map((tip, index) => (
                          <li key={index} className={styles.postQuestion__coachTipItem}>
                            <span className={styles.postQuestion__coachBullet}>•</span>
                            <span className={styles.postQuestion__coachTipText}>{tip}</span>
                          </li>
                        ))}
                      </ul>
                    </div>
